...
export const HistoryIcon = () => <MaterialCommunityIcons name='table-clock' size={30} color='gray' />;

export const SettingIcon = () => <MaterialCommunityIcons name='cog-outline' size={30} color='gray' />;
